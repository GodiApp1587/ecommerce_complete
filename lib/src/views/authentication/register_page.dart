...
class RegisterPage extends GetWidget<AuthController> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildPWTextField(size),
                              const SizedBox(
                                height: 8,
                              ),
                              _buildRePWTextField(size),
                              const SizedBox(
                                height: 8,
                              ),
                              _buildErrorMsg(),
                        ...
                        Expanded(
                          flex: 1,
                          child: _buildSignUpButton(size),
                        ),

                        //footer section. google, facebook button and sign up text here
                        Expanded(
                          flex: 3,
                          child: Center(child: _buildFooter(size)),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _buildPWTextField(Size size) {
    return Container(
      alignment: Alignment.center,
      height: size.height / 12,
      decoration: BoxDecoration(
          ...
          children: <Widget>[
            ...
            Obx(() => Expanded(
                  child: TextField(
                    ...
                    obscureText: authController.isShowPW.value,
                    style: GoogleFonts.inter(
                      fontSize: 14.0,
                      color: Colors.white,
                      fontWeight: FontWeight.w500,
                    ...
                    decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          color: Colors.white70,
                          icon: authController.isShowPW.value
                              ? const Icon(Icons.visibility)
                              : const Icon(Icons.visibility_off),
                          onPressed: () {
                            authController.isShowPW.value =
                                !authController.isShowPW.value;
                          },
                        ),
                        border: InputBorder.none),
  ...
  Widget _buildRePWTextField(Size size) {
    return Container(
      alignment: Alignment.center,
      height: size.height / 12,
      decoration: BoxDecoration(
          ...
          children: <Widget>[
            ...
            Obx(() => Expanded(
                  child: TextField(
                    ...
                    cursorColor: Colors.white70,
                    keyboardType: TextInputType.visiblePassword,
                    obscureText: authController.isShowrePW.value,
                    style: GoogleFonts.inter(
                      fontSize: 14.0,
                      color: Colors.white,
                      fontWeight: FontWeight.w500,
                    ...
                    decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          color: Colors.white70,
                          icon: authController.isShowrePW.value
                              ? const Icon(Icons.visibility)
                              : const Icon(Icons.visibility_off),
                          onPressed: () {
                            authController.isShowrePW.value =
                                !authController.isShowrePW.value;
                          },
                        ),
                        border: InputBorder.none),
  ...
  Widget _buildErrorMsg() {
    return Obx(() => Visibility(
          visible: authController.errorRegistMsg.value.isNotEmpty,
          child: Text(
            '*${authController.errorRegistMsg.value}',
            style: GoogleFonts.inter(
              fontSize: 14.0,
              color: Colors.red,
